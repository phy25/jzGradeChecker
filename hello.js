	...
	jzgc.ajax.getExamList(
		function(r){
			...
			bootstro.start('.bootstro', {
				...
				finishButton: '',
				items: [
					{"selector":"p.text-right:last small","title":"欢迎使用 jzGradeChecker","content":'<p>这是一个帮你更好查成绩的扩展。下面带你看看它的基本功能吧。</p><p><small>如果不需要查看导览，<a href="'+href+'">请点这里退出</a>。下面这个地方可以重新打开导览。</small></p>',"width":"240px","placement":"top",step:0},
					{"selector":"#form-stuinfo","title":"输入信息","content":'<p>无论是查成绩还是导出成绩，你需要先输入你的学号和成绩查询密码。查成绩还需要选考试场次。</p><p>放心，扩展不会上传任何学号密码信息。</p><p>现在，你不需要输入信息。</p>',"width":"350px","placement":"bottom", step:1},
